...
def get_tuner_cls_with_callbacks(tuner_class: Type[base_tuner.BaseTuner]):
  ...
  class CustomTuner(tuner_class):  # pylint: disable=E0239,use-symbolic-message-instead
    """A CustomTuner class which overrides the tuner trial callbacks."""
...
class Executor(base_executor.BaseExecutor):
  ...
  def Do(self, input_dict: Dict[str, List[types.Artifact]],
    ...
    if hasattr(tuner, 'get_tuner_plot_data') and inspect.ismethod(
